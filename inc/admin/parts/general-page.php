			...
			<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="row app_type_wrap">
								<div class="col-md-3">
									<div class="radio-wrap">
										<label>
											<input type="radio" name="app_type"
												   value="dealership" <?php if ( $appType == 'dealership' ) {
												echo 'checked';
											} ?> />
											Dealership
										</label>
									...
									<div class="radio-wrap">
										<label>
											<input type="radio" name="app_type"
												   value="classified" <?php if ( $appType == 'classified' ) {
												echo 'checked';
											} ?>/>
											Classified
										</label>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class='image-preview-wrapper'>
								...
								<?php else: ?>
									<img id='image-preview' width='100' height='100' style='max-height: 100px; width: 100px;'>
								<?php endif; ?>
							</div>
							...
							<div class='image-preview-wrapper'>
								<?php if ( $background_splash_screen_image_id != 0 ) : ?>
									<img id='image-preview-background-splash-screen-image_id'
										 ...
										 width='100' height='100' style='max-height: 100px; width: 100px;'>
								<?php else: ?>
									<img id='image-preview-background-splash-screen-image_id' width='100'
					...
					<div class="row">
						<div class="col-md-4">
							...
							<select name="main_page_ra_view">
								<option value="main_ra_list_view" <?php if ( $mpViewType == 'main_ra_list_view' ) {
									echo 'selected';
								} ?>>
									List View
								</option>
								<option value="main_ra_grid_view" <?php if ( $mpViewType == 'main_ra_grid_view' ) {
									echo 'selected';
								} ?>>
									Grid View
								</option>
				...
				<div class="tab-pane fade" id="v-pills-ad-mob" role="tabpanel"
					...
					<div class="firebase-admob-keys">
						...
						<div class="banner-ids-wrap <?php if ( $adType == 'banner' ) {
						...
						<div class="interstitial-ids-wrap <?php if ( $adType == 'interstitial' ) {
							echo esc_attr( 'visible' );
						} ?>">
							<table>
								<tr>
